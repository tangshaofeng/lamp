        ...
        <div class="mws-panel-body no-padding">
            ...
            <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info">
                <thead>
                    ...
                    <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 212px;">账号</th>
                    <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 133px;">头像</th>
                    <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 97px;">性别</th>
                    <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 97px;">手机号</th>
                    <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 97px;">注册时间</th>
                    <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 97px;">用户权限</th>
            ...
            <tbody role="alert" aria-live="polite" aria-relevant="all">
            	...
            	<tr class="odd">
                    ...
                    <td class="sorting" style="text-align:center;">{{ $v['username'] }}</td>
                    <td class="sorting"style="text-align:center;"><img src="/upload/pic/{{ $v['userpic'] }}" alt="" width="65" height='70'></td>
                    <td class="sorting"style="text-align:center;">{{ $v['sex'] }}</td>
                    <td class="sorting"style="text-align:center;">{{ $v['phonenum'] }}</td>
                    <td class="sorting"style="text-align:center;">{{ $v['usertime'] }}</td>
                    <td class="sorting"style="text-align:center;">{{ $v['userqx'] }}</td>
                    <td class="sorting"style="text-align:center;">
                    	<a href="/admin/user/delete/{{$v['id']}}" style="color:black;font-size:20px;margin-left:20px;" title="删除"><i class="icon-trash"></i></a>
                    	<a href="/admin/user/edit/{{$v['id']}}" style="color:black;font-size:20px;margin-left:20px;" title="修改"><i class="icon-pencil-2"></i></a>
                    </td>
                </tr>
                @endforeach
                </tbody>
