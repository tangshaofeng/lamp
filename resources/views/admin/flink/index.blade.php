        ...
        <div class="mws-panel-body no-padding">
            ...
            <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info">
                <thead>
                    ...
                    <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 212px;">链接名称</th>
                    <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 133px;">链接图片</th>
                    <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 97px;">链接地址</th>
                    <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 97px;">链接描述</th>
                    <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 97px;">添加时间</th>
            ...
            <tbody role="alert" aria-live="polite" aria-relevant="all">
            	...
            	<tr class="odd">
                    ...
                    <td class="sorting" style="text-align:center;">{{ $v['linkname'] }}</td>
                    <td class="sorting"style="text-align:center;"><img src="/upload/linkpic/{{ $v['linkpic'] }}" alt="" width="65" height='70'></td>
                    <td class="sorting"style="text-align:center;">{{ $v['linkurl'] }}</td>
                    <td class="sorting"style="text-align:center;">{{ $v['description'] }}</td>
                    <td class="sorting"style="text-align:center;">{{ $v['linktime'] }}</td>
                    <td class="sorting"style="text-align:center;">
                    	<a href="/admin/flink/delete/{{$v['id']}}" style="color:black;font-size:20px;margin-left:20px;" title="删除"><i class="icon-trash"></i></a>
                    	<a href="/admin/flink/edit/{{$v['id']}}" style="color:black;font-size:20px;margin-left:20px;" title="修改"><i class="icon-pencil-2"></i></a>
                    </td>
                </tr>
                @endforeach
                </tbody>
