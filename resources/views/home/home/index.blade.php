			...
			<div class="banner">
                      <!--轮播 -->
						...
						<div class="am-slider am-slider-default scoll" data-am-flexslider id="demo-slider-0">
							<ul class="am-slides">
								<li class="banner1"><a href="introduction.html"><img src="/upload/image/{{$lunbotu['picone']}}" /></a></li>
								<li class="banner2"><a><img src="/upload/image/{{$lunbotu['pictwo']}}" /></a></li>
								<li class="banner3"><a><img src="/upload/image/{{$lunbotu['picthree']}}" /></a></li>
								<li class="banner4"><a><img src="/upload/image/{{$lunbotu['picfour']}}" /></a></li>
							</ul>
						</div>
						<div class="clear"></div>	
			</div>
														...
														<div class="area-bg">
															<div class="menu-srot">
																<div class="sort-side">
																	...
																	<dl class="dl-sort">
																		<dt><span title="蛋糕">{{$vv['name']}}</span></dt>
																		@foreach($vv['sub'] as $kkk=>$vvv)
																		<dd><a title="蒸蛋糕" href="#"><span>{{$vvv['name']}}</span></a></dd>
																		@endforeach
																	</dl>
																	@endforeach
																	<!-- <dl class="dl-sort">
   				...
   				<div id="f1" style="width:100%;height:520px;overflow:hidden">
					...
					<div class="am-g am-g-fixed floodFour">
						<div class="am-u-sm-5 am-u-md-4 text-one list ">
							<div class="word">
							@foreach($v['sub'] as $kk=>$vv)
								<a class="outer" href="#"><span class="inner"><b class="text">{{$vv['name']}}</b></span></a>
							@endforeach								
							</div>
							<a href="# ">
								<div class="outer-con ">
