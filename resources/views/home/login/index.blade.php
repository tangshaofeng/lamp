			...
			<div class="login-main">
				...
				<div class="login-box">
						...
						<div class="login-form">
							<form method="post" action="/home/login/denglu">
							{{ csrf_field() }}
							<div class="user-name">
							...
							<div class="login-links" >
								<label for="remember-me" style="position:relative;top:20px;"><input id="remember-me" type="checkbox">记住密码</label>
								<a href="#" class="am-fr" style="position:relative;top:20px;">忘记密码</a>
